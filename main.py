...
parser.add_argument('-project', type=str, default='global_local')
parser.add_argument('-name', type=str, default='test')
parser.add_argument('-exp_num')
parser.add_argument('-proto',type=int, default=1000)
...
prototype_shape = (args.proto, 64, 1, 1)#settings_CUB_DOG.prototype_shape
...
data_path = '../data/full/'#Bone_Fracture_Binary_Classification/Bone_Fracture_Binary_Classification/'#'../data_legacy/full/full_'

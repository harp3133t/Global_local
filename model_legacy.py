...
class PPNet(nn.Module):
    ...
    def _l2_convolution(self, x, attentions):
        '''
    ...
    def prototype_distances(self, x, attentions):
        ...
        distances = self._l2_convolution(conv_features, attentions )
    ...
    def forward(self, x):
        ...
        distances, conv_features = self.prototype_distances(x, attentions )
        # print('conv_featrues.shape:', conv_features.shape)
        '''
        ...
        return logits, min_distances, attentions, conv_features

    def push_forward(self, x):
        attentions = self.get_attention(x)
        '''this method is needed for the pushing operation'''
        conv_output = self.conv_features(x)
        distances = self._l2_convolution(conv_output, attentions)


        return conv_output, distances, attentions 
